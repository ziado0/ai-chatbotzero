        ...
        const response = await fetch(this.apiEndpoint, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are a helpful bilingual AI assistant that can communicate fluently in both Arabic and English. Respond in the same language the user writes in. If the user writes in Arabic, respond in Arabic. If the user writes in English, respond in English. Be concise, friendly, and helpful in your responses.'
                    },
                    ...this.messages
                ],
                max_tokens: 200,
