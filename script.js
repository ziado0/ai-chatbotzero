class ChatBot {
    constructor() {
        // Hardcoded API key - replace 'YOUR_API_KEY_HERE' with your actual DeepSeek API key
        this.apiKey = 'sk-180207b0e7f54d58a5e6c70702a5692b';
    ...
    checkApiKey() {
        if (!this.apiKey || this.apiKey === 'YOUR_API_KEY_HERE') {
            this.addMessage('bot', 'Please update the API key in script.js to start chatting!');
        }
    }

    async sendMessage() {
        const message = this.messageInput.value.trim();
        if (!message || !this.apiKey || this.apiKey === 'YOUR_API_KEY_HERE') return;
