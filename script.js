class ChatBot {
    constructor() {
        ...
        this.apiEndpoint = 'https://api-inference.huggingface.co/models/google/flan-t5-base';
        this.messages = [];
    ...
    async sendMessage() {
        ...
        try {
            ...
            if (response && Array.isArray(response) && response.length > 0) {
                ...
                const prompt = `Answer this question helpfully and concisely: ${message}`;
    ...
    async callHuggingFaceAPI() {
        ...
        const response = await fetch(this.apiEndpoint, {
            ...
            body: JSON.stringify({
                inputs: `Answer this question helpfully and concisely: ${userMessage}`,
                parameters: {
                    max_new_tokens: 100,
                    temperature: 0.7,
                    do_sample: true
